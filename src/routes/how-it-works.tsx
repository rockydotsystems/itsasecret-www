    ...
    <>
      ...
      <main className="docs-main">
        ...
        <section className="docs-section">
          ...
          <p>
            Go idle for more than 30 minutes and the next command asks again:
          </p>
          <CodeBlock>
          ...
          <p>
            ...
            (sudo-style), so it works even where output is captured, like direnv loading your{' '}
        ...
        <section className="docs-section">
          ...
          <p>
            ...
            under it and are stored re-encrypted under the org key, so the database holds only
            ciphertext. Even the session&rsquo;s own org-key material is stored encrypted under a
            key the server does not persist: the client supplies it per request. A stolen
